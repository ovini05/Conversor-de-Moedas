...
Este back-end foi desenvolvido em Java, utilizando Spring Boot e Spring Security para demonstrar, no contexto acadêmico, 
como implementar autenticação com JWT em uma aplicação de conversão de moedas. Além de gerenciar o registro e login de usuários,
ele protege as rotas da aplicação e integra com um banco de dados MySQL para persistir dados de forma segura, utilizando criptografia de senhas com o PasswordEncoder.
